...
st.set_page_config(page_title="AI Trading Intelligence V3 - Cloud Ready", layout="wide")
...
def generate_simulated_rates(timeframe_label):
    # Membuat simulasi pergerakan data harga live 30 candle terakhir secara otomatis
...
# =======================================================
st.title("🤖 AI Trading Intelligence V3 - Cloud Ready Engine")
st.caption("Sistem Analisis Multi-Timeframe (H1 & M15) Nonstop 24 Jam dengan Fitur Proteksi Lot Maksimal 0.05 Lot.")
...
if st.button("🚀 Aktifkan Siklus Auto-Analisis & Entry Sekarang"):
    ...
    # Menghasilkan data pasar otomatis tanpa bentrok dengan ekosistem Linux Cloud
...
5. Berikan hasil akhir keputusan di baris paling bawah dengan format teks baku: STRATEGY_DECISION: BUY atau STRATEGY_DECISION: SELL atau STRATEGY_DECISION: NO TRADE."""
        ...
        if rencana_keuangan:
            ...
            st.warning("Robot Status: Menahan Diri (No Trade). Kondisi indikator tidak cukup kuat untuk melakukan entry.")
