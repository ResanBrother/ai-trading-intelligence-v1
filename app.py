    ...
    if not api_key:
        ...
        with st.spinner("AI sedang memproses indikator teknikal, Liquidity Sweep, dan struktur PO3..."):
            try:
                ...
                # PERBAIKAN UTAMA: Menggunakan indeks pilihan [0] agar kompatibel dengan objek API OpenAI terbaru
                keputusan_ai = response.choices[0].message.content.strip().upper()
